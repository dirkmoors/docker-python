...
push: push-python-2.7.15 push-python-3.5.5 push-python-3.6.6 push-python-3.7.0

build: build-python-2.7.15 build-python-3.5.5 build-python-3.6.6 build-python-3.7.0
...
" > data$(PYTHON_VERSION).yml
	...
	docker pull python:$(PYTHON_VERSION)-alpine
...
#	docker pull python:$(PYTHON_VERSION)-slim-jessie
